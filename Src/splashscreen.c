...
void splash_screen_update(void)
{
	...
	*/
	...
	CP_Input_KeyDown(KEY_Q) ? splash_screen_init(), windowSizeX = 1280, windowSizeY = 720 : NULL;
	CP_Input_KeyDown(KEY_W) ? splash_screen_init(), windowSizeX = 1920, windowSizeY = 1080: NULL;
