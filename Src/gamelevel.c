...
CP_Image Bob, BobL, heart, chest, Bomb, fail_screen, clear_screen, pause_menu, purple_orb, yellow_orb, particle, jumpParticle;
// Bob Variables
double Bobx, Boby;
...
void Game_Level_Init() {
	...
	chest = CP_Image_Load("Assets/Chest.png"); Bomb = CP_Image_Load("Assets/Bomb.png"); 
